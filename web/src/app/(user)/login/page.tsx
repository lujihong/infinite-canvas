            ...
            <section className="w-full max-w-[420px]">
                <div className="mb-7 text-center">
                    <img
                        src="/logo.png"
                        alt="新元宝视频工作台"
                        className="mx-auto mb-4 block h-16 w-auto max-w-[200px] object-contain"
                    />
                    <h1 className="text-2xl font-bold tracking-tight text-stone-950 dark:text-stone-100">新元宝视频工作台</h1>
                    <p className="mt-2 text-sm leading-6 text-stone-500 dark:text-stone-400">专业 AI 图像与视频创作生产力工作台</p>
                </div>
